...
/**
 * Home object for domain model class Version.
 * @see pe.com.cotic.test.modelo.Version
 * @author Hibernate Tools
 */
public class VersionHome {

	private static final Log log = LogFactory.getLog(VersionHome.class);
	...
	public void persist(Version transientInstance) {
	...
	public Version merge(Version detachedInstance) {
		...
		try {
			Version result = (Version) sessionFactory.getCurrentSession()
	...
	public Version findById(java.lang.Integer id) {
		...
		try {
			Version instance = (Version) sessionFactory.getCurrentSession()
					.get("pe.com.cotic.test.modelo.Version", id);
			if (instance == null) {
	...
	public List findByExample(Version instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("pe.com.cotic.test.modelo.Version")
